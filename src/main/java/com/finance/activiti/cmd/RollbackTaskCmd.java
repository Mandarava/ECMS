...
import com.finance.activiti.cmd.graph.ActivitiHistoryGraphBuilder;
import com.finance.activiti.cmd.graph.Edge;
import com.finance.activiti.cmd.graph.Graph;
import com.finance.activiti.cmd.graph.Node;
...
public class RollbackTaskCmd implements Command<Object> {
    ...
    public Integer rollbackUserTask(CommandContext commandContext) {
        ...
        HistoricActivityInstanceEntity historicActivityInstanceEntity = this
                .findTargetHistoricActivity(commandContext, taskEntity, targetActivity);

        // 找到想要回退对应的任务历史
        HistoricTaskInstanceEntity historicTaskInstanceEntity = this
                .findTargetHistoricTask(commandContext, taskEntity, targetActivity);
    ...
    public HistoricActivityInstanceEntity findTargetHistoricActivity(
        ...
        return (HistoricActivityInstanceEntity) commandContext
                ...
                .findHistoricActivityInstancesByQueryCriteria(
                        historicActivityInstanceQueryImpl, new Page(0, 1)).get(0);
    }
    ...
    public HistoricTaskInstanceEntity findTargetHistoricTask(
        ...
        return (HistoricTaskInstanceEntity) commandContext
                .getHistoricTaskInstanceEntityManager()
    ...
    public HistoricActivityInstanceEntity getHistoricActivityInstanceEntity(
        ...
        return (HistoricActivityInstanceEntity) Context
                .getCommandContext()
                .getHistoricActivityInstanceEntityManager()
                .findHistoricActivityInstancesByQueryCriteria(
        ...
        if (this.userId == null) {
            if (this.useLastAssignee) {
                ...
                TaskDefinition taskDefinition = processDefinitionEntity
                        .getTaskDefinitions().get(historicTaskInstanceEntity.getTaskDefinitionKey());
